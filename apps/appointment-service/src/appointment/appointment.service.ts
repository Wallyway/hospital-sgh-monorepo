...
export class AppointmentService {
  ...
  async getSpecialties() {
    ...
    console.log(
      '[AppointmentService] [getSpecialties] Consultando departamentos en:',
      url,
    );
    try {
      const response = await this.httpService.axiosRef.get(url);
      console.log(
        '[AppointmentService] [getSpecialties] Respuesta:',
        response.data,
      );
      return response.data;
    } catch (error) {
      console.error(
        '[AppointmentService] [getSpecialties] Error:',
        error.message,
        error,
      );
      return [];
  ...
  async getMedicById(idMedico: number) {
    ...
    console.log(
      '[AppointmentService] [getMedicById] Consultando médico en:',
      url,
    );
    try {
      const response = await this.httpService.axiosRef.get(url);
      console.log(
        '[AppointmentService] [getMedicById] Respuesta:',
        response.data,
      );
      return response.data;
    } catch (error) {
      console.error(
        '[AppointmentService] [getMedicById] Error:',
        error.message,
        error,
      );
      return null;
  ...
  async getAvailableMedics(specialty: string, date: string, time: string) {
    ...
    console.log(
      '[AppointmentService] [getAvailableMedics] Consultando médicos en:',
      medicsUrl,
    );
    let medics: any[] = [];
    try {
      ...
      console.log(
        '[AppointmentService] [getAvailableMedics] Médicos recibidos:',
        medics,
      );
    } catch (error) {
      console.error(
        '[AppointmentService] [getAvailableMedics] Error consultando médicos:',
        error.message,
        error,
      );
      return [];
    ...
    for (const medic of medics) {
      ...
      console.log(
        `[AppointmentService] [getAvailableMedics] Consultando citas para médico ${medic.idMedico} en:`,
        citasUrl,
      );
      let citas: any[] = [];
      try {
        ...
        console.log(
          `[AppointmentService] [getAvailableMedics] Citas recibidas para médico ${medic.idMedico}:`,
          citas,
        );
      } catch (error) {
        console.error(
          `[AppointmentService] [getAvailableMedics] Error consultando citas para médico ${medic.idMedico}:`,
          error.message,
          error,
        );
        continue;
      ...
      const overlap = citas.some((cita) => {
        ...
        return (
          citaDate.getTime() >= start.getTime() &&
          citaDate.getTime() < end.getTime()
        );
      });
      if (!overlap) {
        ...
        try {
          ...
          if (idUsuario) {
            const usuarioResp = await this.httpService.axiosRef.get(
              `http://localhost:3001/auth/users/${idUsuario}`,
            );
            nombre = usuarioResp.data?.nombre;
          }
        } catch (error) {
          console.error(
            `[AppointmentService] [getAvailableMedics] Error obteniendo nombre para idUsuario ${medic.empleado?.idUsuario || medic.idUsuario}:`,
            error.message,
            error,
          );
        }
        ...
        console.log(
          `[AppointmentService] [getAvailableMedics] Médico ${medic.idMedico} disponible en la franja.`,
        );
      } else {
        console.log(
          `[AppointmentService] [getAvailableMedics] Médico ${medic.idMedico} NO disponible en la franja.`,
        );
      }
    }
    console.log(
      '[AppointmentService] [getAvailableMedics] Médicos disponibles:',
      availableMedics,
    );
  ...
  async createAppointment(body: any, user: any) {
    console.log(
      '[AppointmentService] [createAppointment] Iniciando con body:',
      body,
      'user:',
      user,
    );
    ...
    if (!idMedico || !fechaYHora) {
      console.error(
        '[AppointmentService] [createAppointment] Faltan datos requeridos: idMedico o fechaYHora',
      );
    ...
    console.log(
      '[AppointmentService] [createAppointment] idUsuario determinado:',
      idUsuario,
    );
    if (!idUsuario) {
      console.error(
        '[AppointmentService] [createAppointment] No se pudo determinar el idUsuario del usuario autenticado',
      );
      throw new Error(
        'No se pudo determinar el idUsuario del usuario autenticado',
      );
    }
    ...
    console.log(
      '[AppointmentService] [createAppointment] Consultando paciente en:',
      pacienteUrl,
    );
    ...
    try {
      ...
      console.log(
        '[AppointmentService] [createAppointment] Paciente encontrado:',
        paciente,
      );
    } catch (error) {
      console.error(
        '[AppointmentService] [createAppointment] Error consultando paciente:',
        error.message,
        error,
      );
    ...
    console.log(
      '[AppointmentService] [createAppointment] idPaciente real determinado:',
      idPaciente,
    );
    ...
    if (!medic || !medic.idDepartamento) {
      console.error(
        '[AppointmentService] [createAppointment] No se encontró el médico o su departamento',
      );
      throw new Error('No se encontró el médico o su departamento');
    }
    const idDepartamento = medic.idDepartamento;
    console.log(
      '[AppointmentService] [createAppointment] idDepartamento del médico:',
      idDepartamento,
    );
    // 2. Consultar médicos disponibles en ese departamento y franja
    let availableMedics: any[] = [];
    try {
      availableMedics = await this.getAvailableMedics(
        idDepartamento,
        date,
        time.slice(0, 5),
      );
      console.log(
        '[AppointmentService] [createAppointment] Médicos disponibles para la franja:',
        availableMedics,
      );
    } catch (error) {
      console.error(
        '[AppointmentService] [createAppointment] Error al consultar disponibilidad:',
        error.message,
        error,
      );
    ...
    const isAvailable = availableMedics.some(
      (medic: any) => String(medic.idMedico) === String(idMedico),
    );
    console.log(
      '[AppointmentService] [createAppointment] isAvailable:',
      isAvailable,
    );
    if (!isAvailable) {
      console.error(
        '[AppointmentService] [createAppointment] El médico no está disponible en la franja seleccionada',
      );
    ...
    console.log(
      '[AppointmentService] [createAppointment] Enviando POST a:',
      url,
      'con payload:',
      citaPayload,
    );
    try {
      ...
      console.log(
        '[AppointmentService] [createAppointment] Respuesta de cardiology-service:',
        response.data,
      );
      return response.data;
    } catch (error) {
      console.error(
        '[AppointmentService] [createAppointment] Error creando cita en cardiology-service:',
        error.message,
        error,
      );
      throw new Error(
  ...
  async getAppointments(user: any) {
    console.log(
      '[AppointmentService] [getAppointments] Iniciando con user:',
      user,
    );
    ...
    const idUsuario = user?.idPaciente || user?.userId || user?.sub;
    console.log(
      '[AppointmentService] [getAppointments] idUsuario determinado:',
      idUsuario,
    );

    if (!idUsuario) {
      console.error(
        '[AppointmentService] [getAppointments] No se pudo determinar el idUsuario del usuario autenticado',
      );
      throw new Error(
        'No se pudo determinar el idUsuario del usuario autenticado',
      );
    ...
    const pacienteUrl = `http://localhost:3004/patients/by-user/${idUsuario}`;
    console.log(
      '[AppointmentService] [getAppointments] Consultando paciente en:',
      pacienteUrl,
    );
    ...
    try {
      ...
      paciente = pacienteResponse.data;
      console.log(
        '[AppointmentService] [getAppointments] Paciente encontrado:',
        paciente,
      );
    } catch (error) {
      console.error(
        '[AppointmentService] [getAppointments] Error consultando paciente:',
        error.message,
        error,
      );
      throw new Error('No se encontró el paciente autenticado');
    ...
    const idPaciente = paciente.idPaciente;
    console.log(
      '[AppointmentService] [getAppointments] idPaciente real determinado:',
      idPaciente,
    );
    ...
    console.log(
      '[AppointmentService] [getAppointments] Consultando citas en:',
      url,
    );
    ...
    try {
      const response = await this.httpService.axiosRef.get(url);
      console.log(
        '[AppointmentService] [getAppointments] Respuesta de cardiology-service:',
        response.data,
      );
      ...
      const citasEnriquecidas = await Promise.all(
        citas.map(async (cita: any) => {
          try {
            ...
            console.error(
              `[AppointmentService] [getAppointments] Error obteniendo médico ${cita.idMedico}:`,
              error,
            );
            return {
              ...cita,
      ...
      console.log(
        '[AppointmentService] [getAppointments] Citas enriquecidas:',
        citasEnriquecidas,
      );
      return citasEnriquecidas;
    } catch (error) {
      console.error(
        '[AppointmentService] [getAppointments] Error consultando citas:',
        error.message,
        error,
      );
      throw new Error(
  ...
  async cancelAppointment(idCita: number, user: any) {
    console.log(
      '[AppointmentService] [cancelAppointment] Iniciando con idCita:',
      idCita,
      'user:',
      user,
    );
    ...
    const idUsuario = user?.idPaciente || user?.userId || user?.sub;
    console.log(
      '[AppointmentService] [cancelAppointment] idUsuario determinado:',
      idUsuario,
    );

    if (!idUsuario) {
      console.error(
        '[AppointmentService] [cancelAppointment] No se pudo determinar el idUsuario del usuario autenticado',
      );
      throw new Error(
        'No se pudo determinar el idUsuario del usuario autenticado',
      );
    ...
    const pacienteUrl = `http://localhost:3004/patients/by-user/${idUsuario}`;
    console.log(
      '[AppointmentService] [cancelAppointment] Consultando paciente en:',
      pacienteUrl,
    );
    ...
    try {
      ...
      paciente = pacienteResponse.data;
      console.log(
        '[AppointmentService] [cancelAppointment] Paciente encontrado:',
        paciente,
      );
    } catch (error) {
      console.error(
        '[AppointmentService] [cancelAppointment] Error consultando paciente:',
        error.message,
        error,
      );
      throw new Error('No se encontró el paciente autenticado');
    ...
    const idPaciente = paciente.idPaciente;
    console.log(
      '[AppointmentService] [cancelAppointment] idPaciente real determinado:',
      idPaciente,
    );
    ...
    console.log(
      '[AppointmentService] [cancelAppointment] Consultando cita en:',
      citaUrl,
    );
    ...
    try {
      ...
      cita = response.data;
      console.log(
        '[AppointmentService] [cancelAppointment] Cita encontrada:',
        cita,
      );
    } catch (error) {
      console.error(
        '[AppointmentService] [cancelAppointment] Error consultando cita:',
        error.message,
        error,
      );
    ...
    if (cita.idPaciente !== Number(idPaciente)) {
      console.error(
        '[AppointmentService] [cancelAppointment] La cita no pertenece al paciente autenticado',
      );
    ...
    if (cita.estado !== 'R') {
      console.error(
        '[AppointmentService] [cancelAppointment] La cita no está en estado reservada:',
        cita.estado,
      );
    ...
    console.log(
      '[AppointmentService] [cancelAppointment] Cancelando cita en:',
      cancelUrl,
      'con payload:',
      cancelPayload,
    );
    ...
    try {
      ...
      console.log(
        '[AppointmentService] [cancelAppointment] Cita cancelada exitosamente:',
        response.data,
      );
      return response.data;
    } catch (error) {
      console.error(
        '[AppointmentService] [cancelAppointment] Error cancelando cita:',
        error.message,
        error,
      );
      throw new Error(
  ...
  async getMedicAppointments(user: any) {
    console.log(
      '[AppointmentService] [getMedicAppointments] Iniciando con user:',
      user,
    );
    ...
    if (user?.role !== 'MEDIC') {
      console.error(
        '[AppointmentService] [getMedicAppointments] Usuario no es médico:',
        user?.role,
      );
    ...
    if (!idUsuario) {
      console.error(
        '[AppointmentService] [getMedicAppointments] No se pudo determinar el idUsuario',
      );
    ...
    console.log(
      '[AppointmentService] [getMedicAppointments] Consultando médico en:',
      medicUrl,
    );
    ...
    try {
      ...
      medic = response.data;
      console.log(
        '[AppointmentService] [getMedicAppointments] Médico encontrado:',
        medic,
      );
    } catch (error) {
      console.error(
        '[AppointmentService] [getMedicAppointments] Error consultando médico:',
        error.message,
        error,
      );
    ...
    console.log(
      '[AppointmentService] [getMedicAppointments] Consultando médicos del departamento en:',
      medicosUrl,
    );
    ...
    try {
      ...
      console.log(
        '[AppointmentService] [getMedicAppointments] Médicos del departamento:',
        medicos,
      );
    } catch (error) {
      console.error(
        '[AppointmentService] [getMedicAppointments] Error consultando médicos del departamento:',
        error.message,
        error,
      );
    ...
    const medicoAutenticado = medicos.find(
      (m: any) => m.idEmpleado === medic.idEmpleado,
    );
    if (!medicoAutenticado) {
      console.error(
        '[AppointmentService] [getMedicAppointments] No se encontró el médico autenticado en el departamento',
      );
      throw new Error(
        'No se encontró el médico autenticado en el departamento',
      );
    }

    const idMedico = medicoAutenticado.idMedico;
    console.log(
      '[AppointmentService] [getMedicAppointments] idMedico determinado:',
      idMedico,
    );
    ...
    console.log(
      '[AppointmentService] [getMedicAppointments] Consultando citas en:',
      citasUrl,
    );
    ...
    try {
      ...
      const citas = response.data;
      console.log(
        '[AppointmentService] [getMedicAppointments] Citas encontradas:',
        citas,
      );
        ...
        citas.map(async (cita: any) => {
          try {
            ...
            const pacienteResponse =
              await this.httpService.axiosRef.get(pacienteUrl);
            ...
            try {
              if (paciente && paciente.idUsuario) {
                const usuarioResp = await this.httpService.axiosRef.get(
                  `http://localhost:3001/auth/users/${paciente.idUsuario}`,
                );
                nombre = usuarioResp.data?.nombre;
              }
            } catch (error) {
              console.error(
                `[AppointmentService] [getMedicAppointments] Error obteniendo nombre para idUsuario ${paciente?.idUsuario}:`,
                error.message,
                error,
              );
            }
            ...
            console.error(
              `[AppointmentService] [getMedicAppointments] Error obteniendo paciente ${cita.idPaciente}:`,
              error,
            );
            return {
              ...cita,
      ...
      console.log(
        '[AppointmentService] [getMedicAppointments] Citas enriquecidas:',
        citasEnriquecidas,
      );
      return citasEnriquecidas;
    } catch (error) {
      console.error(
        '[AppointmentService] [getMedicAppointments] Error consultando citas:',
        error.message,
        error,
      );
      throw new Error(
  ...
  async getDiagnoses() {
    ...
    try {
      const response = await this.httpService.axiosRef.get(url);
      console.log(
        '[AppointmentService] [getDiagnoses] Diagnósticos obtenidos:',
        response.data,
      );
      return response.data;
    } catch (error) {
      console.error(
        '[AppointmentService] [getDiagnoses] Error:',
        error.message,
        error,
      );
      throw new Error(
  ...
  async addDiagnoses(idCita: number, diagnosticos: number[], user: any) {
    console.log(
      '[AppointmentService] [addDiagnoses] Agregando diagnósticos a cita:',
      idCita,
      'diagnósticos:',
      diagnosticos,
    );
    ...
    try {
      ...
      console.log(
        '[AppointmentService] [addDiagnoses] Diagnósticos agregados exitosamente:',
        response.data,
      );
      return response.data;
    } catch (error) {
      console.error(
        '[AppointmentService] [addDiagnoses] Error:',
        error.message,
        error,
      );
      throw new Error(
        'No se pudieron agregar los diagnósticos: ' +
          (error?.response?.data?.message || error.message),
      );
    }
  }
  ...
  async getMedications() {
    console.log(
      '[AppointmentService] [getMedications] Consultando medicamentos desde farmacy-service',
    );
    const url = 'http://localhost:3007/medications'; // farmacy-service
    try {
      const response = await this.httpService.axiosRef.get(url);
      console.log(
        '[AppointmentService] [getMedications] Medicamentos obtenidos:',
        response.data,
      );
      return response.data;
    } catch (error) {
      console.error(
        '[AppointmentService] [getMedications] Error:',
        error.message,
        error,
      );
      throw new Error(
  ...
  async addPrescriptions(
    ...
    console.log(
      '[AppointmentService] [addPrescriptions] Agregando prescripciones a cita:',
      idCita,
      'prescripciones:',
      prescripciones,
    );
    ...
    try {
      const response = await this.httpService.axiosRef.post(url, payload);
      console.log(
        '[AppointmentService] [addPrescriptions] Prescripciones agregadas exitosamente:',
        response.data,
      );
      return response.data;
    } catch (error) {
      console.error(
        '[AppointmentService] [addPrescriptions] Error:',
        error.message,
        error,
      );
      throw new Error(
        'No se pudieron agregar las prescripciones: ' +
          (error?.response?.data?.message || error.message),
      );
    }
  }
  ...
  async finishAppointment(idCita: number, resumen: string, user: any) {
    console.log(
      '[AppointmentService] [finishAppointment] Finalizando cita:',
      idCita,
      'resumen:',
      resumen,
    );
    ...
    try {
      const response = await this.httpService.axiosRef.post(url, payload);
      console.log(
        '[AppointmentService] [finishAppointment] Cita finalizada exitosamente:',
        response.data,
      );
      return response.data;
    } catch (error) {
      console.error(
        '[AppointmentService] [finishAppointment] Error:',
        error.message,
        error,
      );
      throw new Error(
  ...
  async updateAppointment(
    ...
    console.log(
      '[AppointmentService] [updateAppointment] Actualizando cita:',
      idCita,
      'updates:',
      updates,
    );
    ...
    const idUsuario = user?.idPaciente || user?.userId || user?.sub;
    console.log(
      '[AppointmentService] [updateAppointment] idUsuario determinado:',
      idUsuario,
    );
    if (!idUsuario) {
      console.error(
        '[AppointmentService] [updateAppointment] No se pudo determinar el idUsuario del usuario autenticado',
      );
      throw new Error(
        'No se pudo determinar el idUsuario del usuario autenticado',
      );
    ...
    console.log(
      '[AppointmentService] [updateAppointment] Consultando empleado en:',
      empleadoUrl,
    );
    ...
    try {
      ...
      console.log(
        '[AppointmentService] [updateAppointment] Empleado encontrado:',
        empleado,
      );
    } catch (error) {
      console.error(
        '[AppointmentService] [updateAppointment] Error consultando empleado:',
        error.message,
        error,
      );
    ...
    console.log(
      '[AppointmentService] [updateAppointment] Consultando PAdministrativo en:',
      pAdminUrl,
    );
    ...
    try {
      ...
      console.log(
        '[AppointmentService] [updateAppointment] PAdministrativo encontrado:',
        pAdministrativo,
      );
    } catch (error) {
      console.error(
        '[AppointmentService] [updateAppointment] Error consultando PAdministrativo:',
        error.message,
        error,
      );
    ...
    try {
      ...
      console.log(
        '[AppointmentService] [updateAppointment] Cita actualizada exitosamente:',
        response.data,
      );
      return response.data;
    } catch (error) {
      console.error(
        '[AppointmentService] [updateAppointment] Error:',
        error.message,
        error,
      );
      throw new Error(
  ...
  async getAdminAppointmentHistory(
    ...
    console.log(
      '[AppointmentService] [getAdminAppointmentHistory] Consultando historial administrativo',
    );
    ...
    console.log(
      '[AppointmentService] [getAdminAppointmentHistory] URL:',
      fullUrl,
    );
    ...
    try {
      ...
      console.log(
        '[AppointmentService] [getAdminAppointmentHistory] Historial obtenido:',
        response.data,
      );
      return response.data;
    } catch (error) {
      console.error(
        '[AppointmentService] [getAdminAppointmentHistory] Error:',
        error.message,
        error,
      );
      throw new Error(
        'No se pudo obtener el historial administrativo: ' +
          (error?.response?.data?.message || error.message),
      );
    }
  }
  ...
  private verifyAppointmentTimeWindow(fechaYHora: string) {
    ...
    const timeDiff =
      Math.abs(appointmentTime.getTime() - now.getTime()) / (1000 * 60); // diferencia en minutos

    // Solo permitir operaciones durante la franja de 30 minutos de la cita
    if (timeDiff > 30) {
      throw new Error(
        'Solo se pueden realizar operaciones durante la franja horaria de la cita (30 minutos)',
      );
    }
  }
  ...
  private validateTimeSlot(fechaYHora: string) {
    ...
    if (minutes !== 0 && minutes !== 30) {
      throw new Error(
        'Los horarios de citas deben ser en franjas de 30 minutos exactos (HH:00 o HH:30)',
      );
    }
  }
}

...
Run `npm create vite@latest`, select a name, React framework and JavaScript + SWC variant
...
# Installations
**Before running any installation, make sure you are in the correct folder and not in an external directory.**
